            ...
            <div class="col-12">
                <div class="card table-card">
                    <div class="card-header table-header">
                        ...
                        <a href="{{route('slider.create')}}" class="add-new">Add slider<i class="ms-1 ri-add-line"></i></a>
                    </div>
                    <div class="card-body">
                                ...
                                @foreach($sliders as $slider)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                                ...
                                                <img src="{{ asset('uploads/' . $slider->image)}}" width="100" alt="">
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('slider.show', $slider->id) }}" class="btn btn-sm btn-primary me-2"><i class="fa fa-eye"></i></a>
                                                <a href="{{ route('slider.edit', $slider->id) }}" class="btn btn-sm btn-warning me-2"><i class="fa fa-edit"></i></a>
                                                <form action="{{ route('slider.destroy', $slider->id) }}" method="post" class="d-inline delete-form " data-id="{{ $slider->id }}">
                                                    @csrf
                                                    @method('DELETE')
