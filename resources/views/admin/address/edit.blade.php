                        ...
                        <div class="col-md-8">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control custom-input" name="text" value="{{ $address->text }}">
                                    @if($errors->has('text'))
                                        <div class="error_msg">
                                            {{ $errors->first('text') }}
                                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control custom-input" name="phone" value="{{ $address->phone }}">
                                    @if($errors->has('phone'))
                                        <div class="error_msg">
                                            {{ $errors->first('phone') }}
                                        </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control custom-input" name="full_address" rows="5"  style="resize: none; height: auto">{{ $address->full_address }}</textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="email" class="form-control custom-input" name="email" value="{{ $address->email }}">
                                    @if($errors->has('email'))
                                        <div class="error_msg">
                                            {{ $errors->first('email') }}
                                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control custom-input" name="working_hour" value="{{ $address->working_hour }}">
                                ...
                                <div class="col-md-6 mt-3">
                                    <input type="checkbox" class="form-check-input custom-checkbox" id="customCheckBox1" name="is_show_on_navbar" {{ $address->is_show_on_navbar == 1 ? 'checked disabled' : '' }}>
