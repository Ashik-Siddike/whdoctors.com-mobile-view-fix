            ...
            <div class="card table-card">
                <div class="card-header table-header">
                    <div class="title-with-breadcrumb">
                        <div class="table-title">contentus Section</div>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{route('contentus.index')}}">contentus Section</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page"> Add contentus Section</li>
                            </ol>
                        </nav>
                    </div>
                    <a href="{{route('contentus.index')}}" class="add-new">contentus Section List<i class="ms-1 ri-list-ordered-2"></i></a>
                </div>
                <div class="card-body custom-form">
                    <form action="{{ route('contentus.store') }}" method="POST"
