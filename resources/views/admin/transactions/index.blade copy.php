                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function (data) {
                            ...
                            // buttons += '<a href="' + SITEURL + '/dashboard/transactions' + data + '" class="btn btn-view me-1" title="Cash Transaction"><i class="ri-eye-line"></i></a>';
                            let path = '/dashboard/transactions/';
buttons += `<a href="${SITEURL}${path}${data}" class="btn btn-view me-1" title="Cash Transaction"><i class="ri-eye-line"></i></a>`;
