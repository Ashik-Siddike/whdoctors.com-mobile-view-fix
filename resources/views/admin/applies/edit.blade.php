        ...
        <div class="col-12">
            <div class="card table-card">
                    ...
                    <div class="title-with-breadcrumb">
                        ...
                        <nav aria-label="breadcrumb"> 
                            <ol class="breadcrumb mb-0"> 
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Edit Apply</li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card-body custom-form">
                    <form action="{{ route('apply.update', ['id' => $apply->id]) }}" method="POST"
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control custom-input" name="name" value="{{ $apply->name }}">
                                    @if($errors->has('name'))
                                        <div class="error_msg">
                                            {{ $errors->first('name') }}
                                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control custom-input" name="email" value="{{ $apply->email }}">
                                    @if($errors->has('email'))
                                        <div class="error_msg">
                                            {{ $errors->first('email') }}
                                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control custom-input" name="phone" value="{{ $apply->phone }}">
                                    @if($errors->has('phone'))
                                        <div class="error_msg">
                                            {{ $errors->first('phone') }}
                                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control custom-input" name="address" value="{{ $apply->address }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control custom-input" name="country" value="{{ $apply->country }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control custom-input" name="university" value="{{ $apply->university }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control custom-input" name="course_name" value="{{ $apply->course_name }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control custom-input" name="year" value="{{ $apply->year }}">
                                    @if($errors->has('year'))
                                        <div class="error_msg">
                                            {{ $errors->first('year') }}
                                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="image-select-file">
                                        <label class="form-label custom-label" for="document">
                                            ...
                                            <span id="documentName" class="text-dark text-center">{{ $apply->document }}</span>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="image-select-file">
                                        <label class="form-label custom-label" for="cv">
                                            ...
                                            <span id="cvName" class="text-dark text-center">{{ $apply->cv }}</span>
                                    ...
                                    <div class="image-select-file">
                                        <label class="form-label custom-label" for="logo_image">
                                            ...
                                            <div class="user-image">
                                                <img id="logo_imagePreview" src="{{ asset($apply->passport_front_image) }}" alt="" class="image-preview">
                                ...
                                <div class="col-md-12">
                                    <div class="image-select-file">
                                        <label class="form-label custom-label" for="cover_image">
                                            ...
                                            <div class="user-image">
                                                <img id="cover_imagePreview" src="{{ asset($apply->passport_back_image) }}" alt="" class="image-preview">
