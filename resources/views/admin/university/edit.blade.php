        ...
        <div class="col-12">
            <div class="card table-card">
                ...
                <div class="card-body custom-form">
                    <form action="{{ route('university.update', ['id' => $university->id]) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <select class="form-control custom-input single-select2" name="type">
                                        ...
                                        <option option value="private"  {{ $university->type == 'private' ? 'selected' : ' ' }}>Private</option>
                                    </select>
                                    @if($errors->has('type'))
                                        <div class="error_msg">
                                            {{ $errors->first('type') }}
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control custom-input" name="name" value="{{ $university->name }}">
                                    @if($errors->has('name'))
                                        <div class="error_msg">
                                            {{ $errors->first('name') }}
                                        </div>
...
{{--
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control custom-input single-select2" name="country_id">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select class="form-control custom-input" name="course_id[]" id="multiple-course" multiple="multiple">
                                        @foreach ($courses as $course)
                                            <option value="{{ $course->id }}" {{ in_array($course->id, $university->courses->pluck('id')->toArray()) ? 'selected' : ' ' }}>
                                                {{ $course->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control custom-input" name="program" value="{{ $university->program }}">
                                ...
                                <div class="col-md-6">
                                    <label for="" class="form-label custom-label">Tution Fee</label>
                                    <input type="text" class="form-control custom-input" name="tuition_fee" value="{{ $university->tuition_fee }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control custom-input" name="living_cost" value="{{ $university->living_cost }}">
                                ...
                                {{-- <div class="col-md-6">
                                    <label for="" class="form-label custom-label">Application Date</label>
                                    <input id="datepicker" class="form-control custom-input" name="application_date" value="{{ $university->application_date }}">
                                ...
                                <input id="application_date" type="date" class="form-control custom-input" name="application_date" value="{{ $university->application_date }}" placeholder="Application Date">
                                @if($errors->has('application_date'))
                                ...
                                @endif
                                 ...
                                 <div class="col-md-6">
                                    ...
                                    <input id="application_date2" type="date" class="form-control custom-input" name="application_date_2" value="{{ $university->application_date_2 }}" >
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="application_date2" type="date" class="form-control custom-input" name="application_date_3" value="{{ $university->application_date_3 }}" >
                                ...
                                {{-- <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control custom-input" name="meta_title" value="{{ $university->meta_title }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control custom-input" name="meta_keywords" value="{{ $university->meta_keywords }}">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control custom-input" name="meta_description" value="{{ $university->meta_description }}">
                                ...
                                <div class="col-md-6 my-2">
                                    <input type="checkbox" class="form-check-input custom-checkbox" id="customCheckBox1" name="is_show_homepage"  {{ $university->is_show_homepage == 1 ? 'checked' : '' }}>
                                    <label class="form-check-label custom-checkbox-label" for="customCheckBox1">Is Show Homepage</label>
                                </div>

                                <div class="col-md-6 my-2">
                                    <input type="checkbox" class="form-check-input custom-checkbox" id="customCheckBox1" name="is_partner"  {{ $university->is_partner == 1 ? 'checked' : '' }}>
                                    ...
                                    <div class="image-select-file">
                                        <label class="form-label custom-label" for="logo_image">
                                            ...
                                            <div class="user-image">
                                                <img id="logo_imagePreview" src="{{ asset($university->image) }}" alt="" class="image-preview">
                                ...
                                <div class="col-md-12">
                                    <div class="image-select-file">
                                        <label class="form-label custom-label" for="cover_image">
                                            ...
                                            <div class="user-image">
                                                <img id="cover_imagePreview" src="{{ asset($university->cover_image) }}" alt="" class="image-preview">
...
{{--
                                ...
                                <div class="col-md-12">
                                    <div class="image-select-file">
                                        <label class="form-label custom-label" for="meta_image">
                                            ...
                                            <div class="user-image">
                                                <img id="meta_imagePreview" src="{{ asset($university->meta_image) }}" alt="" class="image-preview">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea id="address" class="form-control custom-input" name="address" rows="5"   style="resize: none; height: auto">{{$university->address}}</textarea>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea id="admission-requirements" class="form-control custom-input" name="admission_requirements" rows="5" style="resize: none; height: auto">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea id="description" class="form-control custom-input" name="description" rows="5"  placeholder="Description"  style="resize: none; height: auto">
