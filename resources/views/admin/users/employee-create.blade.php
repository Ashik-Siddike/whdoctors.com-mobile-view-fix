            ...
            <div class="col-12">
                <div class="card table-card">
                    ...
                    <div class="card-body custom-form">
                        ...
                        enctype="multipart/form-data" class="row g-3 mt-0" autocomplete="off">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control custom-input" name="name" placeholder="Name" value="{{ old('name') }}">
                                        @if($errors->has('name'))
                                            <div class="error_msg">
                                                {{ $errors->first('name') }}
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="email" class="form-control custom-input" name="email" placeholder="Email" value="{{ old('email') }}">
                                        @if($errors->has('email'))
                                            <div class="error_msg">
                                                {{ $errors->first('email') }}
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control custom-input" name="phone_no" placeholder="Phone No" value="{{ old('phone_no') }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control custom-input" name="designation" placeholder="Designation" value="{{ old('designation') }}">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="is_employee" checked>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control custom-input" name="facebook_link" placeholder="Facebook Link" value="{{ old('facebook_link') }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control custom-input" name="twitter_link" placeholder="Twitter Link" value="{{ old('twitter_link') }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control custom-input" name="instagram_link" placeholder="Instagram Link" value="{{ old('instagram_link') }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control custom-input" name="linkdin_link" placeholder="Linkdin Link" value="{{ old('linkdin_link') }}">
                                    ...
                                    <div class="col-xxl-6 col-lg-12">
                                        ...
                                        <textarea class="form-control custom-input" name="address" rows="5"  placeholder="Address"  style="resize: none; height: auto"> {{ old('address') }} </textarea>
                                    ...
                                    <div class="col-xxl-6 col-lg-12">
                                        ...
                                        <textarea class="form-control custom-input" name="description" rows="5"  placeholder="Description"  style="resize: none; height: auto"> {{ old('description') }} </textarea>
