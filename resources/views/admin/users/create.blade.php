                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="is_employee">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control custom-input" name="facebook_link" placeholder="Facebook Link">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control custom-input" name="twitter_link" placeholder="Twitter Link">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control custom-input" name="instagram_link" placeholder="Instagram Link">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control custom-input" name="linkdin_link" placeholder="Linkdin Link">
