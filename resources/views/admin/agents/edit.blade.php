                        ...
                        <div class="card-body custom-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control custom-input" name="name" value="{{ $agent->name }}" id="name">
                                    @if($errors->has('name'))
                                        <div class="error_msg">
                                            {{ $errors->first('name') }}
                                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="email" class="form-control custom-input" name="email" value="{{ $agent->email }}" id="email">
                                    @if($errors->has('email'))
                                        <div class="error_msg">
                                            {{ $errors->first('email') }}
                                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control custom-input" name="phone" value="{{ $agent->phone }}">
                                    @if($errors->has('phone'))
                                        <div class="error_msg">
                                            {{ $errors->first('phone') }}
                                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control custom-input" name="commission_rate" value="{{ $agent->commission_rate }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control custom-input" name="n_id" value="{{ $agent->n_id }}">
                                    @if($errors->has('n_id'))
                                        <div class="error_msg">
                                            {{ $errors->first('n_id') }}
                                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" class="form-control custom-input" name="date_of_birth" value="{{ $agent->date_of_birth }}">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control custom-input" name="address" rows="5"  style="resize: none; height: auto">
                                        {{ $agent->address }}
                                    </textarea>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control custom-input" name="details" rows="5"  style="resize: none; height: auto">
                                        {{ $agent->details }}
                                    </textarea>
                        ...
                        <div class="col-12">
                            <div class="card table-card">
                                ...
                                <div class="custom-form card-body">
                                    <div class="row">
                                        <div class="col-6">
                                            <button type="submit" class="btn save-button">Update
                                    ...
                                    <div class="image-select-file">
                                        <label class="form-label custom-label" for="image">
                                            ...
                                            <div class="user-image">
                                                @if($agent->image)
                                                    <img id="imagePreview" src="{{asset($agent->image)}}" alt="" class="image-preview">
                                                @else
                                    ...
                                    <div class="image-select-file id-card-image">
                                        <label class="form-label custom-label" for="id_card_front_image">
                                            ...
                                            <div class="user-image" style="height: 100px">
                                                @if($agent->id_card_front_image)
                                                    <img id="id_card_front_imagePreview" src="{{asset($agent->id_card_front_image)}}" alt="" class="image-preview">
                                                @else
                                ...
                                <div class="custom-form card-body">
                                    <div class="image-select-file id-card-image">
                                        <label class="form-label custom-label" for="id_card_back_image">
                                            ...
                                            <div class="user-image" style="height: 100px">
                                                @if($agent->id_card_back_image)
                                                    <img id="id_card_back_imagePreview" src="{{asset($agent->id_card_back_image)}}" alt="" class="image-preview">
                                                @else
                                                    <img id="id_card_front_imagePreview" src="{{asset('admin/assets/images/nid.png')}}" alt="" class="image-preview">
                                                @endif
