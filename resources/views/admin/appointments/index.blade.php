                ...
                <div class="card table-card">
                    <div class="card-header table-header">
                        <div class="title-with-breadcrumb">
                            <div class="table-title">Appointments</div>
...
{{--                        <a href="{{route('slider.create')}}" class="add-new">Add slider--}}
{{--                            <i class="ms-1 ri-add-line"></i></a>--}}
                    </div>
                    <div class="card-body">
...
{{--                                <th scope="col">Status</th>--}}
                            ...
                            @foreach($appointments as $i => $item)
                                <tr>
                                    ...
                                    {{-- <td class="text-center">
                                        @php
                                            dd(public_path("storage/uploads/$slider->image"));
                                        @endphp

                                        @if (file_exists(public_path("storage/uploads/$slider->image")))
                                            <img src="{{ asset("storage/uploads/$slider->image") }}" width="100" alt="">
                                        @else
                                            <span>No image</span>
                                        @endif
                                    </td> --}}
...
{{--                                    </td>--}}
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{ route("appointments.show", $item->id) }}" class="btn btn-sm btn-primary me-2"><i class="fa fa-eye"></i></a>
{{--                                            <a href="{{ route('slider.edit', $slider->id) }}" class="btn btn-sm btn-warning me-2"><i class="fa fa-edit"></i></a>--}}
                                            <form action="{{ route('appointments.destroy', $item->id) }}" method="post" class="d-inline delete-form " data-id="{{ $item->id }}">
                                                @csrf
                                                @method('DELETE')
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-danger">
                ...
                <div class="modal-body text-center">
                    <p class="fs-5">Are you sure you want to delete this Appointments?</p>
