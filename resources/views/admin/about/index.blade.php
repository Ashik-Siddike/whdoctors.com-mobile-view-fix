                ...
                <div class="card table-card">
                    <div class="card-header table-header">
                        <div class="title-with-breadcrumb">
                            <div class="table-title">About Section</div>
                        ...
                        <a href="{{route('about.create')}}" class="add-new">Add About Section<i class="ms-1 ri-add-line"></i></a>
                    </div>
                    <div class="card-body">
                        <table class="table dataTable w-100" id="data-table">
                            ...
                            <tbody>
                                @foreach($aboutSection as $i => $item)
                                    <tr>
                                        <td>{{ ++$i }}</td>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('about.show', $item->id) }}" class="btn btn-sm btn-primary me-2"><i class="fa fa-eye"></i></a>
                                                <a href="{{ route('about.edit', $item->id) }}" class="btn btn-sm btn-warning me-2"><i class="fa fa-edit"></i></a>
                                                <form action="{{ route('about.destroy', $item->id) }}" method="post" class="d-inline delete-form" data-id="{{ $item->id }}">
                                                    @csrf
                                                    @method('DELETE')
