                ...
                <div class="card table-card">
                    <div class="card-header table-header">
                        <div class="title-with-breadcrumb">
                            <div class="table-title">aboutNav Section</div>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item">
                                        <a href="{{route('dashboard')}}">Dashboard</a>
                                    </li>
                                    <li class="breadcrumb-item active" aria-current="page">aboutNav Section</li>
                                </ol>
                            </nav>
                        </div>
                        <a href="{{route('aboutNav.create')}}" class="add-new">Add aboutNav Section<i class="ms-1 ri-add-line"></i></a>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                @foreach($aboutNav as $i => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('aboutNav.show', $item->id) }}" class="btn btn-sm btn-primary me-2"><i class="fa fa-eye"></i></a>
                                                <a href="{{ route('aboutNav.edit', $item->id) }}" class="btn btn-sm btn-warning me-2"><i class="fa fa-edit"></i></a>
                                                <form action="{{ route('aboutNav.destroy', $item->id) }}" method="post" class="d-inline delete-form" data-id="{{ $item->id }}">
                                                    @csrf
                                                    @method('DELETE')
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-danger">
            ...
            <div class="modal-body text-center">
                <p class="fs-5">Are you sure you want to delete this aboutNav Section?</p>
