            ...
            <div class="card table-card">
                <div class="card-header table-header">
                    <div class="title-with-breadcrumb">
                        <div class="table-title"><b>Flybd Category</b></div>
                        <nav aria-label="breadcrumb"> 
                            <ol class="breadcrumb mb-0"> 
                                <li class="breadcrumb-item">
                                    <a href="{{route('dashboard')}}">Dashboard</a>
                                </li> 
                                <li class="breadcrumb-item active" aria-current="category">Flybd Category</li> 
                            </ol> 
                        </nav>
                    </div>
                    <a href="{{route('flybds.category.create')}}" class="add-new">Create Category <i class="ms-1 ri-add-line"></i></a>
                </div>
                <div class="card-body">
...
$(document).ready(function () {
    var listUrl = "{{ route('flybds.categories') }}";
                ...
                render: function (data) {
                    return `
                        <div class="action-btn">
                            <a href="{{ route('flybds.category.edit', '') }}/${data}" class="btn btn-edit"><i class="ri-edit-line"></i></a>
                            <a href="javascript:void(0);" class="btn btn-delete" onclick="confirmDeletion('{{ route('flybds.category.delete', '') }}/${data}')"><i class="ri-delete-bin-2-line"></i></a>
                        </div>
                    `;
                }
            }
