            ...
            <div class="col-12">
                <div class="card table-card pb-5">
                    <div class="card-header table-header">
                        ...
                        <a href="{{route('abroad.category.create')}}" class="add-new">Create Category<i class="ms-1 ri-list-ordered-2"></i></a>
                    </div>
                    <div class="card-body custom-form">
                        <form action="{{ route('abroad.category.store') }}" method="POST"
                        class="row g-3 mt-0">
