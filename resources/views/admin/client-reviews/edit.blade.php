        ...
        <div class="col-12">
            <div class="card table-card">
                    ...
                    <div class="title-with-breadcrumb">
                        ...
                        <nav aria-label="breadcrumb"> 
                            <ol class="breadcrumb mb-0"> 
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> Edit Client Review</li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card-body custom-form">
                    <form action="{{ route('client-review.update', ['id' => $client_review->id]) }}" method="POST"
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control custom-input" name="name" value="{{$client_review->name}}">
                                    @if($errors->has('name'))
                                        <div class="error_msg">
                                            {{ $errors->first('name') }}
                                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control custom-input" name="designation" value="{{$client_review->designation}}">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control custom-input" name="review" id="review" rows="5"   style="resize: none; height: auto">{{$client_review->review}}</textarea>
                                    ...
                                    <div class="image-select-file">
                                        ...
                                        <label class="form-label custom-label" for="cover_image">
                                            ...
                                            <div class="user-image">
                                                <img id="cover_imagePreview" src="{{ $client_review->image ? asset($client_review->image) : asset('admin/assets/images/default.jpg') }}" alt="background-image" class="image-preview">
