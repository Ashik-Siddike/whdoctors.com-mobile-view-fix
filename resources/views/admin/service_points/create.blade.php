                    ...
                    <div class="title-with-breadcrumb">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{route('service.index')}}">service Section</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page"> Add service Section</li>
                            </ol>
                        </nav>
                    </div>
                    <a href="{{route('service.index')}}" class="add-new">service Section List<i class="ms-1 ri-list-ordered-2"></i></a>
                </div>
