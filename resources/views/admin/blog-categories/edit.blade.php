                        ...
                        <div class="title-with-breadcrumb">
                            ...
                            <nav aria-label="breadcrumb"> 
                                <ol class="breadcrumb mb-0"> 
                                    ...
                                    <li class="breadcrumb-item active" aria-current="category"> Edit Category</li> 
                                </ol> 
                            </nav>
                        </div>
                        <a href="{{route('blog.categories')}}" class="add-new">Category<i class="ms-1 ri-list-ordered-2"></i></a>
                    </div>
                    <div class="card-body custom-form">
                        <form action="{{ route('blog.category.update', ['id' => $category->id]) }}" method="POST" class="row g-3 mt-0">
