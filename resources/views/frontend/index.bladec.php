...
<div class="home-container">
  ...
  <div class="home-tab-silector">
    <div class="home-sidebar" style="background-color:#84d6707a; ">
      <nav class="home-nav">
        <span data-id="home-features" class="home-text01 tab-link active" style="font-weight: bold;font-family:Times New Roman; color:#000">ABOUT</span>
        <span data-id="service-features" class="home-text02 tab-link" style="font-weight: bold;font-family:Times New Roman; color:#000">EMPLOYEE TEAM</span>
        <span data-id="service-point" class="home-text03 tab-link" style="font-weight: bold;font-family:Times New Roman; color:#000">SERVICE POINT</span>
        <span data-id="contact" class="home-text04 tab-link" style="font-weight: bold;font-family:Times New Roman; color:#000">CONTACTS</span>
      </nav>
    ...
    <div class="home-details">
      ...
      <div id="home-features" class="home-features tab-block" style="    background-color: #84d6707a;">
      ...
      <div id="service-features" class="home-features tab-block d-none" style="background-color: #84d6707a">
              ...
              <div class="col">
                  <div class="card h-100 text-center employee-card">
                      <img src="{{ $employee->image ? asset($employee->image) : asset('images/avatar-3637561_1280.png') }}"
                           ...
                           alt="{{ $employee->name }}"
                           style="width: 100px; height: 100px; background-color:rgb(133, 130, 128);">
                      <div class="card-body">
                          <h5 class="card-title" style="font-family:Times New Roman">{{ $employee->name }}</h5>
                          <p class="card-text" style="font-family:Times New Roman"><strong>Designation:</strong> {{ $employee->designation }}</p>
                          <p class="card-text" style="font-family:Times New Roman"><strong>Email:</strong> {{ $employee->email }}</p>
                          <p class="card-text" style="font-family:Times New Roman" ><strong>Phone:</strong> {{ $employee->phone_no }}</p>
                      </div>
                  </div>
              </div>
          @endforeach
      ...
      <div id="service-point" class="home-features tab-block d-none rounded" style="background-color: #84d6707a">
    ...
    @endforeach
      ...
      <div id="contact" class="home-features tab-block " style="background-color: #84d6707a">
  ...
  <div class="home-testimonials-section" style="background-color:#84d6707a" >
    <div class="home-testimonial-section" style="background-color:#84d6707a">
      <div class="home-testimonial" style="background-color: #84d6707a;">
        <h1 class="home-text22" style="font-family:Times New Roman ;color:#000 !important">
          {{ getContentData(38, 'title'); }}
          <br />
          <span></span>
        </h1>
        {{-- <span class="home-text25" style="font-size: 20px !important;font-family:Times New Roman; color:#000 !important">
          {{ getContentData(38, 'subtitle'); }}
        </span> --}}
  ...
  <div class="home-contact-section">
    <div class="home-contact">
      ...
      <div class="home-form">
        ...
        <form id="myForm"class="home-form1" action="{{ route('message.store') }}" method="POST">
            @csrf
        ...
        <div class="home-testimonial-details" >
            ...
            @foreach ($offices as $office)
                ...
                <div class="testimonial-card1-testimonial-card testimonial-card1-root-class-name3 employee-card" style="background-color: #DC4D01 !important; color:black !important;">
                    ...
                    <h5 class="testimonial-card" style="font-family:Times New Roman ; color:#000 !important">
