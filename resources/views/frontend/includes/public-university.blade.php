...
<table class="table table-striped">
    <h1 class="public-university-text"><span style="font-family:Times New Roman; Color:black;">Public University</span></h1>
    <thead>
    <tr>
    ...
    <tbody>
    @foreach ($publicUniversities as $public_university)
    <tr>
...
{{--        >--}}
{{--        <h1 class="public-university-text"><span style="font-family:Times New Roman;">Public University</span></h1>--}}
