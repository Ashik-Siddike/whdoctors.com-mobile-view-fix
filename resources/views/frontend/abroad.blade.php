...
<div class="home-container">
  ...
  <div class="service_hero" style="background: #84d6707a; width: 100%;">
    <div class="about-us-hero">
      <div class="about-us-container01">
        <h1 class="about-us-text" style="font-family:Times New Roman;">{{ $abroadLivingCategory->title }}</h1>
  ...
  <div class="home-tab-silector">
    <div class="home-details">
      @foreach($abroadLiving as $abroad)
        <div class="home-features tab-block">
          ...
          <div class="home-container03">
            <span class="home-text08" style="font-family:Times New Roman;">
              {!! $abroad->description !!}
            </span>
          </div>
        </div>
